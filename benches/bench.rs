...
fn bench(criterion: &mut Criterion) {
    ...
    group.bench_function("generate 1024 bits", |b| {
        b.iter(|| {
            generate_probable_prime::<16, 32, OsRng>(
                1024, t, &mut rng,
            );
        });
    });
    ...
    group.bench_function("generate 1024 bits in oversized", |b| {
        b.iter(|| {
            generate_probable_prime::<64, 128, OsRng>(
                1024, t, &mut rng,
            );
        });
    });
    ...
    group.bench_function("test 1024 bits", |b| {
        b.iter(|| {
            ...
            is_composite::<64, 128>(candidate, t, &mut rng);
        });
    });
    ...
    group.bench_function("test 2048 bits", |b| {
        b.iter(|| {
            ...
            is_composite::<128, 256>(candidate, t, &mut rng);
        });
    });
}
